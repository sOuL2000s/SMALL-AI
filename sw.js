const CACHE_NAME = 'small-ai-cache-v2.2'; // Update version for new deployments
const API_CACHE_NAME = 'small-ai-api-cache-v2'; // Dedicated cache for API responses (not used for Gemini)
