const CACHE_NAME = 'small-ai-cache-v1'; // Update version for new deployments
const API_CACHE_NAME = 'small-ai-api-cache-v1'; // Dedicated cache for API responses (not used for Gemini)
